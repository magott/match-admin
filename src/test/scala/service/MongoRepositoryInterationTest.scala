...
class MongoRepositoryInterationTest extends FunSuite{
  ...
  val m = Match(None, DateTime.now,"home","away","venue","level",Some("desc"),DateTime.now.plusDays(7),"trio",None,None,Nil,Nil,None,None,None, true, false, None, "payer@example.com", Some("away"), None)
